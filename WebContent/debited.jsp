...
<br>
<center><font color="green">Withdrawn successfully</font></center><br><br>
<center><b>CUSTOMERID:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=a.getCustomerid()%></center><br>
<center><b>ACCOUNTID:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=a.getAccountid() %></center><br>
<center><b>BALANCE BEFORE Withdraw:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=a.getBalance()+ammount%></center><br>
<center><b>BALANCE AFTER Withdraw:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=a.getBalance()%></center><br><br>
